...
MFCApplication1.h
    這是應用程式的主要標頭檔。
    它包含了特定標頭 (包括 Resource.h)，並宣告 CMFCApplication1App 應用程式類別。

MFCApplication1.cpp
    這是含有應用程式類別 CMFCApplication1App 的主要應用程式原始程式檔。
...
MFCApplication1Dlg.h、MFCApplication1Dlg.cpp - 對話方塊
    這些檔案包含您的 CMFCApplication1Dlg 類別。這個類別會定義應用程式主對話方塊的行為。對話方塊的範本是在可於 Microsoft Visual C++ 編輯的 MFCApplication1.rc 中。
